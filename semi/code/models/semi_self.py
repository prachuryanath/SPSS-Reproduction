...
class ConvBlock(nn.Module):
    """
    A basic convolutional block that applies a 2D convolution, 
...
class DecoderBlock(nn.Module):
    """
    A decoder block that consists of two convolutional layers and 
    an optional transposed convolution for upsampling.
    """
...
class SideoutBlock(nn.Module):
    """
    A side-output block used for generating intermediate 
...
class Encoder(nn.Module):
    """
    ResNet34-based feature extractor that encodes input 
    images into deep feature maps.
    """
...
class MyModel(nn.Module):
    """
    A deep learning model with a dual-branch architecture for segmentation and inpainting.
    ...
    Returns:
        Tuple: 
        - Segmentation mask.
        - Inpainted boundary prediction.
        - Intermediate inpainting outputs.
